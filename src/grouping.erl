...
%% returns a list of submaster nodes by dividing all the nodes into a number of s_groups and returns the head of each group as submaster node
...
create_submaster_nodes([Submaster|_Workers], _Size, 1, Acc) ->
